...
![Monthly Sales per Year](project/reports/images/monthly_sales.png)
...
![Top Customers](project/reports/images/top_customers.png)

### 🔹 Product Analysis
- Most profitable product: S18_3232  
- Highest quantity sold: S18_3232  

![Top Products](project/reports/images/top_products.png)

### 🔹 Geographic Analysis
- Top country by sales: USA (~36.16% of total revenue)  
- Top 5 countries contribute ~70.41% of total sales  

![Top Countries](project/reports/images/top_countries.png)  
![Sales Share Pie](project/reports/images/country_pie.png)

### 🔹 Price Analysis
- Price distribution: mean $83.66, std $20.17, min $26.88, max $100.0  
- High-value orders (> $5,000): 0  

![Price Distribution](project/reports/images/price_distribution.png)
